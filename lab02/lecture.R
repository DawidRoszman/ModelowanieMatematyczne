...
#Przyklad0
#==========
#a) Prawdopodobienstwo, ze w 60 rzutach moneta symetryczna wypadnie dokładnie 30(35) orlow.
#Oznaczmy X - liczba orlow w n rzutach moneta symetryczna, 
#X ma rozklad B(n,p)=B(60,0.5) 
#P(X=10)=?

dbinom(30,60,0.5); dbinom(35,60,0.5); dbinom(c(30,35),60,0.5) 
...
set.seed(5)
X=rpois(n,lambda)    
Y=(X-lambda)/sqrt(lambda) #standaryzacja
...
dbinom(50,n,p)
lambda <- 50
dpois(50, lambda = lambda)

dbinom(c(10,30,50,70), 100, 0.5)
dpois(10, lambda = lambda); dpois(30, lambda = lambda); dpois(50, lambda = lambda); dpois(70, lambda = lambda)
